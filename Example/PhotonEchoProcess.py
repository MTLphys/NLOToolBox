# -*- coding: utf-8 -*-
"""
Process file for the Photon Echo Generator Code make sure to match the Load mat to the save mat name in the
generating file used 
...
fw = 8.0
E0 = .015
File = loadmat('2photonHeterodyneMC2.mat')
S12= File['S12']
DT = File['DT'][0]
t = File['t'][0]
wl1= File['wl1'][0]
